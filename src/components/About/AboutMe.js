  ...
  return (
      ...
      <div ref={domRef} className={`aboutMe-enter ${isVisible ? 'visible' : ''}`}>
        ...
        <div id="aboutMeText">
          ...
          In my spare time, I enjoy developing a suite of personal
          projects, which are available on my GitHub. Each project has tangible,
          real-world applications and covers a wide range of technologies. My work
          showcases a combination of Software Engineering skills—such as creating
          web applications and front-end pages—and Cybersecurity expertise,
          including bypassing security measures like reCAPTCHA, rate limiting, and
